            ...
            <article key={client.id} className="rounded-2xl border border-slate-200 bg-white px-4 py-4 shadow-sm">
              <div className="flex items-start justify-between gap-3">
                <div className="flex min-w-0 items-start gap-3">
                  <UserAvatar user={client} size="lg" className="h-11 w-11 border border-slate-200" fallbackClassName="bg-indigo-50 text-indigo-700 dark:bg-indigo-950/70 dark:text-indigo-100" />
